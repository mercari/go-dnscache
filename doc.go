...
// It asynchronously lookups DNS and reflesh results. The main motivation of this package
// is to avoid too much DNS lookups for every requests (DNS lookup sometimes makes request
